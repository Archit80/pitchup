    ...
    <>
      ...
      <section className="section_container">
        ...
        <div className="space-y-5 mx-auto max-w-4xl mt-10">
          ...
          {parsedContent ? (
            <article
              className="markdown prose max-w-4xl font-work-sans break-all"
        ...
        <br />
        {/* VOTES SECTION */}
        <div className="flex gap-10 items-center max-w-4xl mx-auto">
          {/* <p className="text-30-semibold"> Community Interaction </p> */}
          <p className="text-16-medium  "> LIKED THIS PITCH ? CAST YOUR VOTE HERE</p>
        ...
        <div className="mb-16">
              ...
              <div key={index} className="flex items-start ">
                <div className="flex items-start gap-3 my-4 w-full mx-auto">
                  ...
                  <div>
                    ...
                    <p className="font-normal break-all leading-tight">
                      {comment.text}
                    </p>
                  </div>
                </div>
          ...
          {userId ? (
            ...
            <p className="text-16-medium text-black-200 max-w-4xl mx-auto">
              {" "}
              Please{" "}
              <ScrollToTopLink href="#" className="text-blue-500">
                {" "}
                login{" "}
              </ScrollToTopLink>{" "}
              to leave a comment{" "}
